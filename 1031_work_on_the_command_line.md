...
### Bash
As anyother thing in linux you can choose your shell (The command line interface). Bash in the most common one.
...
## history
The bash, saves the commands you issue in a file defined in **HISTFILE** ev. the ````hostory```` shows the full command hostory (500 commands normally but can be changes in HISTSIZE).
